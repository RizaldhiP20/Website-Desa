    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card gradient-4">
                <div class="card-body">
                    <h3 class="card-title text-white">Surat Selesai</h3>
                    <div class="d-inline-block">
                        <h2 class="text-white">{{ $surat_selesai }}</h2>
                            ...
                            <table class="table table-xs mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.surat.show', $surat->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i> Detail</a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
